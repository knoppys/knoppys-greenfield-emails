...
<head>
	...
	<title>Greenfield IT Recruitment</title><!--[if !mso]><!== -->
							...
							<div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
								...
								<div align="center" class="img-container center" style="padding-right: 0px; padding-left: 0px;">
									...
									<div style="line-height:5px;font-size:1px">
										&#160;
									</div><img align="center" alt="Greenfield IT Recruitment" border="0" class="center" src="<?php echo get_site_url();?>/wp-content/uploads/2017/06/cropped-logo.png" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 193px" title="Image" width="193"><!--[if mso]></td></tr></table><![endif]-->
								</div><!--[if (!mso)&(!IE)]><!-->
							</div><!--<![endif]-->
						</div>
					</div><!--[if (mso)|(IE)]></td></tr></table></td></tr></table><![endif]-->
